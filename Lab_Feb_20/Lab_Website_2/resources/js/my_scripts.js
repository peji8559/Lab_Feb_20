...
function loadStatsPage(){
	var table = document.getElementById("stats_table");//Retrieve our table element
		...
		var table2 = document.getElementById("winlostable");
		table2.rows[1].cells[0].innerHTML = count;
		table2.rows[1].cells[1].innerHTML = countL;
}
